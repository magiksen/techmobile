					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Opciones SEO</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-8">
	<div class="card">
		...
		<input type="hidden" name="id" value="{{ $seo->id }}">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Meta Descripción </h6>
				</div>
				<div class="col-sm-9 text-secondary">

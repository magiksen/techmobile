...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Agregar Banner </div>
					<div class="ps-3">
...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('store.banner') }}" enctype="multipart/form-data" >
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Titulo del Banner</h6>
				</div>
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">URL del Banner</h6>
				</div>
				<div class="form-group col-sm-9 text-secondary">
			...
			<div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Imagen del Banner</h6>
				</div>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                banner_title: {
                    required : 'Por favor ingresa el titulo del banner',
                },
                banner_url: {
                    required : 'Por favor ingresa la url del banner ',
                },
            },
            errorElement : 'span',

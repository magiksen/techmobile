					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Editar Cupón </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('update.coupon') }}"   >
	...
	<div class="row mb-3">
		<div class="col-sm-3">
			<h6 class="mb-0">Fecha de validez</h6>
		</div>
		<div class="form-group col-sm-9 text-secondary">
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                coupon_name: {
                    required : 'Por favor ingresa un nombre para el cupón',
                },
                coupon_discount: {
                    required : 'Por favor ingresa el descuento del cupón',
                },
            },
            errorElement : 'span',

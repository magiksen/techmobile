...
<div class="page-content">
	<h6 class="mb-0 text-uppercase">Actualizar imagen destacada </h6>
	<hr>
<div class="card">
<form method="post" action="{{ route('update.product.thambnail') }}" enctype="multipart/form-data" >
	...
	<div class="card-body">
		<div class="mb-3">
			<label for="formFile" class="form-label">Selecciona la imagen destacada </label>
...
<input type="submit" class="btn btn-primary px-4" value="Guardar cambio" />
...
<div class="page-content">
	<h6 class="mb-0 text-uppercase">Actualizar imagenes del producto </h6>
	<hr>
<div class="card">
<div class="card-body">
 ...
 <form method="post" action="{{ route('update.product.multiimage') }}" enctype="multipart/form-data" >
	...
	<tr>
		...
		<td>
	<input type="submit" class="btn btn-primary px-4" value="Subir imagen " />
	<a href="{{ route('product.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete" > Borrar </a>
		</td>
	</tr>
	@endforeach

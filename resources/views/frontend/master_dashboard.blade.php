        ...
        rows += `<tr class="pt-30">
                        ...
                        <td class="text-center detail-info" data-title="Stock">
                            ${value.product.product_qty > 0
                                ...
                                :`<span class="stock-status out-stock mb-0">No Disponible</span>`
...
<!--  /// Start Load Compare Data -->
    <script type="text/javascript">
        ...
        rows += ` <tr class="pr_image">
                                    <td class="text-muted font-sm fw-600 font-heading mw-200">Previsualizar</td>
    <td class="row_img"><img src="/${value.product.product_thambnail} " style="width:300px; height:300px;"  alt="compare-img" /></td>
            ...
            <tr class="pr_remove text-muted">
                ...
                <td class="row_remove">
                    <a type="submit" class="text-muted"  id="${value.id}" onclick="compareRemove(this.id)"><i class="fi-rs-trash mr-5"></i><span>Remover</span> </a>
                </td>

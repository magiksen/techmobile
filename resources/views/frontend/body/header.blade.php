                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                ...
                                <li><a href="#">Tracking de pedios</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Envío 100% seguro</li>
                                    <li>Los mejores equipos del mercado al mejor precio</li>
...
{{--                </li>--}}
                 ...
                 <li>Necesitas ayuda? Llamanos: <strong class="text-brand"> +584262219083</strong></li>
    ...
    <div class="header-right">
        <div class="search-style-2">
            ...
            <form action="{{ route('product.search') }}" method="post">
                ...
                <input onfocus="search_result_show()" onblur="search_result_hide()" name="search" id="search" placeholder="Buscar por..." />
...
{{--                </div>--}}
     ...
     <div class="header-action-icon-2">
        ...
        <a href="{{ route('compare') }}"><span class="lable ml-0">Comparar</span></a>
    </div>
                ...
                <div class="header-action-icon-2">
                    ...
                    <a href="{{ route('mycart') }}"><span class="lable">Carrito</span></a>
          ...
          <!--   // End mini cart start with ajax -->
                        ...
                        <div class="shopping-cart-footer">
                            ...
                            <div class="shopping-cart-button">
                                <a href="{{ route('mycart') }}" class="outline">Ver carrito</a>
    ...
    @auth
    <a href="{{ url('/dashboard') }}"><span class="lable ml-0">Cuenta</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
            <ul>
                <li>
                    <a href="{{ route('dashboard') }}"><i class="fi fi-rs-user mr-10"></i>Mi Cuenta</a>
                </li>
                <li>
                    <a href="{{ route('user.logout') }}"><i class="fi fi-rs-sign-out mr-10"></i>Salir</a>
                </li>
            </ul>
                                    </div>

    @else
  <a href="{{ route('login') }}"><span class="lable ml-0">Iniciar sesión</span></a>

  <span class="lable" style="margin-left: 2px; margin-right: 2px;" > | </span>


 <a href="{{ route('register') }}"><span class="lable ml-0">Registrarse</span></a>
                    ...
                    <div class="header-nav d-none d-lg-flex">
                        <div class="main-categori-wrap d-none d-lg-block">
                            <a class="categories-button-active" href="#">
                                <span class="fi-rs-apps"></span>   Todas las categorías
    ...
    <div class="mobile-header-active mobile-header-wrapper-style">
        <div class="mobile-header-wrapper-inner">
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="site-copyright">Techmobile 2023 © Todos los derechos reservados </div>
            </div>
        </div>
    </div>

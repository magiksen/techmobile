...
<head>
    <meta charset="utf-8" />
    <title>Iniciar Sesión - Techmobile </title>
    ...
    <div class="login_wrap widget-taber-content background-white">
        <div class="padding_eight_all bg-white">
            <div class="heading_s1">
                ...
                <p class="mb-30">No tienes una cuenta? <a href="{{ url('/register') }}">Crea una aquí</a></p>
            </div>
           ...
           <form method="POST" action="{{ route('login') }}">
            @csrf
                ...
                <div class="form-group">
                    <input type="email" id="email"  required="" name="email" placeholder="Usuario ó Email *" />
                </div>
                <div class="form-group">
                    <input required="" id="password" type="password" name="password" placeholder="Tu contraseña *" />
                </div>
                ...
                <div class="login_footer form-group mb-50">
                    <div class="chek-form">
                        <div class="custome-checkbox">
                            ...
                            <label class="form-check-label" for="exampleCheckbox1"><span>Recuerdame</span></label>
                        </div>
                    </div>

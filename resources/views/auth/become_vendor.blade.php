...
<head>
    <meta charset="utf-8" />
    <title>Conviertete en proveedor </title>
        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span>  Conviertete en proveedor
                </div>
            </div>
        </div>
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">Conviertete en proveedor</h1>
         <p class="mb-30">Ya tienes una cuenta de proveedor? <a href="{{ route('vendor.login') }}">Proveedor Login</a></p>
                                        </div>
 ...
 <div class="form-group">
     ...
     <div class="form-group">
         <select name="vendor_join" class="form-select mb-3" aria-label="Default select example">
            <option selected="">Selecciona la fecha de unión</option>
    ...
    <div class="login_footer form-group mb-50">
        <div class="chek-form">
            <div class="custome-checkbox">
                ...
                <label class="form-check-label" for="exampleCheckbox12"><span>Acepto los termino y politicas.</span></label>
            </div>
        </div>
        <a href="#"><i class="fi-rs-book-alt mr-5 text-muted"></i>Leer mas</a>
    </div>
    <div class="form-group mb-30">
        <button type="submit" class="btn btn-fill-out btn-block hover-up font-weight-bold" name="login">Enviar y registrar</button>
    </div>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                <div class="text-center">
                    <img src="{{ asset('frontend/assets/imgs/theme/loading.gif') }}" alt="" width="260px"/>
                </div>
            </div>
        </div>
    </div>

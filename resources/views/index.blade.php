...
<div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
    <div class="card">
        ...
        <div class="card-body">
            <p>
                Desde el panel de control de su cuenta, puede consultar y ver fácilmente sus <a href="#">pedidos recientes</a>,<br />
                gestionar sus <a href="#">direcciones de envío y facturación</a> y <a href="#">modificar los detalles de su cuenta.</a>
            </p>
        </div>
    </div>
</div>
